/* Sad 'N Stranded
	...
	Version 1: 2015
	Revised: 2016, 2018
	GitHub: https://github.com/cyfrmedia/sad-n-stranded
*/
...
public class ChooseYourOwnAdventure
{
	...
	public static void main(String[]args)
	{
		...
		print("Please keep all entries lowercase. If you are going somewhere, use 'go to (place you are going to)' You have hunger, tiredness, and thirst meters.");
		//game variables
		String room = "beach";
		boolean wood = false;
		boolean radio = false;
		...
		while(hours < 35)
		{
			...
			if(room.equals("beach"))
			{
				...
				if(r == 0)
				{
					print("There are also berries here. They are safe to eat.");
				}
			...
			if(room.equals("cave"))
			{
				...
				else if(action.contains("fire"))
				{
					...
					{
						print("You have nothing to light on fire.");
					}
				}
				...
				else if(action.contains("cow"))
				{
					if(cowMeat == true)
					{
						print("You cooked and ate some beef.");
						cowMeat = false;
						hunger = 0;
					}
					else
